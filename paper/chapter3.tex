...
\section{Downloading}
First rule possible to complete in our workflow was downloading data from publicly available databases.
We made this rule easily extensible for new sources of information by writing a new script for downloading, 
naming it \texttt{download\_from\_db} where \texttt{db} is name of the database and appending this name into variable DATABASES in config file.
