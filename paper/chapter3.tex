...
naming it TODO:
% \texttt{{\{script_dir\}\\download\_from\_\{db\}}} 
...
% \texttt{{'phage[Title] AND (complete genome[Title] OR complete sequence[Title]) AND (viruses[filter] AND biomol_genomic[PROP] AND ("10000"[SLEN] : "100000000"[SLEN]))'}}.
