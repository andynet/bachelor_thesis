...
genomes_output_file = 'NCBI_' + str(datetime.date.today()) + '.genomes.fasta'
genomes_conversion_file = 'NCBI_' + str(datetime.date.today()) + '.genomes.conversion'
genomes_output = open(genomes_output_file, 'w')
genomes_conversion = open(genomes_conversion_file, 'w')

genes_output_file = 'NCBI_' + str(datetime.date.today()) + '.genes.fasta'
genes_conversion_file = 'NCBI_' + str(datetime.date.today()) + '.genes.conversion'
